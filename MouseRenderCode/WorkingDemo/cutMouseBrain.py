...
colors_list = pkl.load(open('data/permuted_colors.pkl','rb'))
meta = pkl.load(open('data/meta_information.pkl','rb'))

def main():
    colors = vtk.vtkNamedColors()

    Data=np.load('data/tessaltions_compressed.npz')
